...
class AddProduct(FlaskForm):
    ...
    category = SelectField("Category", choices=["Perfumes", "Oils", "ToothPastes", "Tubes", "Soaps", "Creams", "Lotions", "Wigs", "Toilet Papers", "Underwear", "Relaxers", "Makeups", "Roll-on", "Glycerine", "Styling Gel", "Shower Gel", "Cleanser", "Hair Dye", "Hand Sanitizer", "Shampoo", "Conditioner"])
...
class Categorize(FlaskForm):
    category = SelectField("Category", choices=["All", "Perfumes", "Oils", "ToothPastes", "Tubes", "Soaps", "Creams", "Lotions", "Wigs", "Toilet Papers", "Underwear", "Relaxers", "Makeups", "Roll-on", "Glycerine", "Styling Gel", "Shower Gel", "Cleanser", "Hair Dye", "Hand Sanitizer", "Shampoo", "Conditioner"])
